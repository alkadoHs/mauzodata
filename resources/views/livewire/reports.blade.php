<div clss="w-full">
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-200 leading-tight">
            {{ __('Reports tabs here...')}}
        </h2>
    </x-slot>

    <div class="py-6">
        <div>
            <p class="text-2xl">Here is how your businness is doing</p>
        </div>

        <div class="grid gap-8">
            <div class="space-y-4">
                <div class="flex items-center gap-2">
                    <span class="bg-cyan-300 p-2 rounded-full">
                        <x-heroicon-o-chart-bar class="size-5" />
                    </span>
                    <p class="text-xl font-bold text-cyan-900">Sales reports</p>
                </div>
                <div class="grid items-center grid-cols-2 lg:grid-cols-4 gap-6">
                    <a href="{{ route('time-range')}}" wire:navigate class="p-4 group bg-white rounded shadow-lg flex items-center gap-2 border-2 border-transparent hover:border-cyan-400">
                        <x-heroicon-o-document-chart-bar class="size-10 text-blue-400" />
                        <p class="group-hover:text-blue-600 group-hover:underline group-hover:underline-offset-4">Daily, Weekly, Monthly and Yearly</p>
                    </a>

                    <a href="" class="p-4 group bg-white rounded shadow-lg flex items-center gap-2 border-2 border-transparent hover:border-cyan-400">
                        <x-heroicon-o-document-chart-bar class="size-10 text-blue-400" />
                        <p class="group-hover:text-blue-600 group-hover:underline group-hover:underline-offset-4">Sales by branch</p>
                    </a>

                    <a href="" class="p-4 group bg-white rounded shadow-lg flex items-center gap-2 border-2 border-transparent hover:border-cyan-400">
                        <x-heroicon-o-document-chart-bar class="size-10 text-blue-400" />
                        <p class="group-hover:text-blue-600 group-hover:underline group-hover:underline-offset-4">Sales by product</p>
                    </a>

                    <a href="" class="p-4 group bg-white rounded shadow-lg flex items-center gap-2 border-2 border-transparent hover:border-cyan-400">
                        <x-heroicon-o-document-chart-bar class="size-10 text-blue-400" />
                        <p class="group-hover:text-blue-600 group-hover:underline group-hover:underline-offset-4">Top Customers</p>
                    </a>
                </div>
            </div>
            ...
            <div class="space-y-4">
                <div class="flex items-center gap-2">
                    ...
                    <p class="text-xl font-bold text-cyan-900">Profit & Loss(P&L) Reports</p>
                </div>
                <div class="grid items-center grid-cols-2 lg:grid-cols-4 gap-6">
                    <a href="" class="p-4 group bg-white rounded shadow-lg flex items-center gap-2 border-2 border-transparent hover:border-cyan-400">
                        <x-heroicon-o-document-chart-bar class="size-10 text-blue-400" />
                        <p class="group-hover:text-blue-600 group-hover:underline group-hover:underline-offset-4">Overall profit margin</p>
                    </a>

                    <a href="" class="p-4 group bg-white rounded shadow-lg flex items-center gap-2 border-2 border-transparent hover:border-cyan-400">
                        <x-heroicon-o-document-chart-bar class="size-10 text-blue-400" />
                        <p class="group-hover:text-blue-600 group-hover:underline group-hover:underline-offset-4">Profit by product</p>
                    </a>
                </div>
            </div>
            ...
            <hr class="border border-gray-300">
             ...
             <div class="space-y-4">
                <div class="flex items-center gap-2">
                    ...
                    <p class="text-xl font-bold text-cyan-900">Inventory Reports</p>
                </div>
                <div class="grid items-center grid-cols-2 lg:grid-cols-4 gap-6">
                    <a href="" class="p-4 group bg-white rounded shadow-lg flex items-center gap-2 border-2 border-transparent hover:border-cyan-400">
                        <x-heroicon-o-document-chart-bar class="size-10 text-blue-400" />
                        <p class="group-hover:text-blue-600 group-hover:underline group-hover:underline-offset-4">Stock levels</p>
                    </a>

                    <a href="" class="p-4 group bg-white rounded shadow-lg flex items-center gap-2 border-2 border-transparent hover:border-cyan-400">
                        <x-heroicon-o-document-chart-bar class="size-10 text-blue-400" />
                        <p class="group-hover:text-blue-600 group-hover:underline group-hover:underline-offset-4">Low stock alerts</p>
                    </a>

                    <a href="" class="p-4 group bg-white rounded shadow-lg flex items-center gap-2 border-2 border-transparent hover:border-cyan-400">
                        <x-heroicon-o-document-chart-bar class="size-10 text-blue-400" />
                        <p class="group-hover:text-blue-600 group-hover:underline group-hover:underline-offset-4">Dead stocks</p>
                    </a>
                </div>
            </div>
            <hr class="border border-gray-300">
             ...
             <div class="space-y-4">
                <div class="flex items-center gap-2">
                    ...
                    <p class="text-xl font-bold text-cyan-900">Payment and Credit Sale Reports</p>
                </div>
                <div class="grid items-center grid-cols-2 lg:grid-cols-4 gap-6">
                    <a href="" class="p-4 group bg-white rounded shadow-lg flex items-center gap-2 border-2 border-transparent hover:border-cyan-400">
                        <x-heroicon-o-document-chart-bar class="size-10 text-blue-400" />
                        <p class="group-hover:text-blue-600 group-hover:underline group-hover:underline-offset-4">Credit Sales Report</p>
                    </a>

                    <a href="" class="p-4 group bg-white rounded shadow-lg flex items-center gap-2 border-2 border-transparent hover:border-cyan-400">
                        <x-heroicon-o-document-chart-bar class="size-10 text-blue-400" />
                        <p class="group-hover:text-blue-600 group-hover:underline group-hover:underline-offset-4">Accounts Receivable</p>
                    </a>
                </div>
            </div>
            <hr class="border border-gray-300">
             ...
             <div class="space-y-4">
                <div class="flex items-center gap-2">
                    ...
                    <p class="text-xl font-bold text-cyan-900">Branch Perfomance Reports</p>
                </div>
                <div class="grid items-center grid-cols-2 lg:grid-cols-4 gap-6">
                    <a href="" class="p-4 group bg-white rounded shadow-lg flex items-center gap-2 border-2 border-transparent hover:border-cyan-400">
                        <x-heroicon-o-document-chart-bar class="size-10 text-blue-400" />
                        <p class="group-hover:text-blue-600 group-hover:underline group-hover:underline-offset-4">Branch Sales Comparison</p>
                    </a>

                    <a href="" class="p-4 group bg-white rounded shadow-lg flex items-center gap-2 border-2 border-transparent hover:border-cyan-400">
                        <x-heroicon-o-document-chart-bar class="size-10 text-blue-400" />
                        <p class="group-hover:text-blue-600 group-hover:underline group-hover:underline-offset-4">Branch Expenses</p>
                    </a>
                </div>
            </div>
            <hr class="border border-gray-300">
             ...
             <div class="space-y-4">
                <div class="flex items-center gap-2">
                    ...
                    <p class="text-xl font-bold text-cyan-900">Sales Trends and Forecasts</p>
                </div>
                <div class="grid items-center grid-cols-2 lg:grid-cols-4 gap-6">
                    <a href="" class="p-4 group bg-white rounded shadow-lg flex items-center gap-2 border-2 border-transparent hover:border-cyan-400">
                        <x-heroicon-o-document-chart-bar class="size-10 text-blue-400" />
                        <p class="group-hover:text-blue-600 group-hover:underline group-hover:underline-offset-4">Seasonal Sales Trends</p>
                    </a>

                    <a href="" class="p-4 group bg-white rounded shadow-lg flex items-center gap-2 border-2 border-transparent hover:border-cyan-400">
                        <x-heroicon-o-document-chart-bar class="size-10 text-blue-400" />
                        <p class="group-hover:text-blue-600 group-hover:underline group-hover:underline-offset-4">Sales Forecasting</p>
                    </a>
                </div>
            </div>
            <hr class="border border-gray-300">
             ...
             <div class="space-y-4">
                <div class="flex items-center gap-2">
                    ...
                    <p class="text-xl font-bold text-cyan-900">Employee Perfomance Reports</p>
                </div>
                <div class="grid items-center grid-cols-2 lg:grid-cols-4 gap-6">
                    <a href="" class="p-4 group bg-white rounded shadow-lg flex items-center gap-2 border-2 border-transparent hover:border-cyan-400">
                        <x-heroicon-o-document-chart-bar class="size-10 text-blue-400" />
                        <p class="group-hover:text-blue-600 group-hover:underline group-hover:underline-offset-4">Sales by Seller</p>
                    </a>

                    <a href="" class="p-4 group bg-white rounded shadow-lg flex items-center gap-2 border-2 border-transparent hover:border-cyan-400">
                        <x-heroicon-o-document-chart-bar class="size-10 text-blue-400" />
                        <p class="group-hover:text-blue-600 group-hover:underline group-hover:underline-offset-4">Order Processing Time</p>
                    </a>
                </div>
            </div>
            <hr class="border border-gray-300">
             ...
             <div class="space-y-4">
                <div class="flex items-center gap-2">
                    ...
                    <p class="text-xl font-bold text-cyan-900">Expense Tracking</p>
                </div>
                <div class="grid items-center grid-cols-2 lg:grid-cols-4 gap-6">
                    <a href="" class="p-4 group bg-white rounded shadow-lg flex items-center gap-2 border-2 border-transparent hover:border-cyan-400">
                        <x-heroicon-o-document-chart-bar class="size-10 text-blue-400" />
                        <p class="group-hover:text-blue-600 group-hover:underline group-hover:underline-offset-4">Operational Costs</p>
                    </a>

                    <a href="" class="p-4 group bg-white rounded shadow-lg flex items-center gap-2 border-2 border-transparent hover:border-cyan-400">
                        <x-heroicon-o-document-chart-bar class="size-10 text-blue-400" />
                        <p class="group-hover:text-blue-600 group-hover:underline group-hover:underline-offset-4">Costs by Branch</p>
                    </a>
                </div>
            </div>
            <hr class="border border-gray-300">
